...
public class DmLobbyActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //Instead of a file stream here, we need payloads
        try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.Add_Character:
                startActivity(new Intent(DmLobbyActivity.this, PlayerCreateActivity.class));
            default:
